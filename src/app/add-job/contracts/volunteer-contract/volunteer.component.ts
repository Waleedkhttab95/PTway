...
@Component({
  selector: 'app-vol-contract',
  templateUrl: './volunteer.component.html',
  styleUrls: ['./volunteer.component.css']
})

export class VolContractComponent implements OnInit {
  ...
  // ];
    ...
    ngOnInit() {
      ...
      this.addJobForm = new FormGroup({
        ...
        work_days: new FormControl(1 ,
           {validators: [Validators.required,Validators.min(1), Validators.max(59)]}),
    ...
    addJob() {
      ...
      this.data = {
        ...
        contract: this.contracts[0].value,
