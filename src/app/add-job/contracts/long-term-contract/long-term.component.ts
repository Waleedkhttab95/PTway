...
export class LongTermComponent implements OnInit {
  ...
  private fb: FormBuilder, public signSerive: SignUpService, public userSerivce: UserService) { }
    ...
    workDays = [{value:'60',viewValue:'2'},
    {value:'90',viewValue:'3  '},
    {value:'120',viewValue:'4'},
    {value:'150',viewValue:'5 '},
    {value:'180',viewValue:'6 '},];
  ...
  // ];
    ...
    ngOnInit() {
      ...
      this.addJobForm = new FormGroup({
        ...
        salary: new FormControl(1500 ,
           {validators: [Validators.required,Validators.min(1500)]}),
    ...
    addJob() {
      ...
      this.data = {
        ...
        contract: this.contracts[1].value,
