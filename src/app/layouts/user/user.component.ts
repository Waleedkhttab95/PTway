...
export class UserComponent implements OnInit {
  ...
  constructor(private router: Router, private element: ElementRef, public userService: UserService, private dataService: DataService, private authService: AuthService) { }
