...
/* harmony import */ var _company_profile_company_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../company-profile/company.service */ "./src/app/company-profile/company.service.ts");
...
var EditCompanyProfileComponent = /** @class */ (function () {
    function EditCompanyProfileComponent(companyService, rest, route, router, fb, jobService) {
    ...
    EditCompanyProfileComponent.prototype.getcountry = function () {
        var _this = this;
        this.countries = [];
        this.jobService.getcountry().subscribe(function (data) {
            for (var key in data) {
                _this.countries.push({ value: data[key]._id, viewValue: data[key].countryName });
            }
        });
    };
    EditCompanyProfileComponent.prototype.getcity = function () {
        var _this = this;
        this.cities = [];
        this.jobService.getcity().subscribe(function (data) {
            for (var key in data) {
    ...
    EditCompanyProfileComponent.prototype.ngOnInit = function () {
        ...
        this.companyService.getCompanyInfo().subscribe(function (result) {
            if (result.personal_web != 'null')
                _this.personal_web = result.personal_web;
            if (result.facebook != 'null')
                _this.facebook = result.facebook;
            if (result.twitter != 'null')
                _this.twitter = result.twitter;
            if (result.instagram != 'null')
                _this.instagrm = result.instagram;
            if (result.linkedin != 'null')
                _this.linkedin = result.linkedin;
            _this.comapnyResumeForm.setValue({
                ...
                personal_web: _this.personal_web,
                facebook: _this.facebook,
                twitter: _this.twitter,
                instagram: _this.instagrm,
                linkedin: _this.linkedin
            });
        });
    };
    EditCompanyProfileComponent.prototype.onUpdate = function () {
    };
    EditCompanyProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_company_profile_company_service__WEBPACK_IMPORTED_MODULE_4__["CompanyService"], _rest_service__WEBPACK_IMPORTED_MODULE_1__["RestService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _add_job_job_service__WEBPACK_IMPORTED_MODULE_5__["JobService"]])
...
var RestService = /** @class */ (function () {
    ...
    RestService.prototype.getUsers = function (id) {
        return this.http.get(BackUrl + 'users/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData));
    };
    RestService.prototype.userRegistreing = function (data) {
        return this.http.post(BackUrl + 'api/userRegistreing', JSON.stringify(data), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log("user Registre succes w/ id=" + data.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('userRegistreing')));
    };
    RestService.prototype.companyRegistreing = function (data) {
        return this.http.post(BackUrl + 'api/companyRegistreing', JSON.stringify(data), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log("comapny Registre succes w/ id=" + data.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('companyRegistreing')));
    };
    RestService.prototype.postuserinfo = function (data) {
        return this.http.post(BackUrl + 'api/postuserinfo', JSON.stringify(data), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log("user succes complete his data  w/ id=" + data.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('postuserinfo')));
    };
    RestService.prototype.userlogin = function (data) {
        console.log(data);
        return this.http.post(BackUrl + 'api/login', JSON.stringify(data), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log("user login succes w/ id=" + data.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('userlogin')));
    };
    RestService.prototype.postcompanyinfo = function (data) {
        console.log(data);
        return this.http.post(BackUrl + 'api/postcompanyinfo', JSON.stringify(data), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log("company succes complete data w/ id=" + data.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('postcompanyinfo')));
    };
    RestService.prototype.updateProduct = function (id, product) {
        return this.http.put(BackUrl + 'products/' + id, JSON.stringify(product), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("updated product id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateProduct')));
    };
    RestService.prototype.deleteProduct = function (id) {
        return this.http.delete(BackUrl + 'products/' + id, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("deleted product id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteProduct')));
    };
