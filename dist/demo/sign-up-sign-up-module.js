...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(rest, authService, route, router, fb) {
        ...
        this.userPassword = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', [
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].nullValidator,
        ]);
    ...
    SignUpComponent.prototype.userRegistreing = function () {
        ...
        this.authService.createUser(this.userRegistrForm.value.firstName, this.userRegistrForm.value.lastName, this.userRegistrForm.value.userEmail, this.userRegistrForm.value.userPassword);
    };
